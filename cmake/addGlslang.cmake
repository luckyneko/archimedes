...
if(NOT DEFINED ACM_GLSL_COMPILER)
	...
	if(_acm_glslc)
		...
		set(ACM_GLSL_COMPILER "${_acm_glslc}" CACHE STRING "GLSL->SPIR-V compiler command")
		set(ACM_GLSL_COMPILER_FLAG "" CACHE STRING "GLSL compiler flag")
	elseif(_acm_glslang)
		message(STATUS "Using system glslang: ${_acm_glslang}")
		set(ACM_GLSL_COMPILER "${_acm_glslang}" CACHE STRING "GLSL->SPIR-V compiler command")
		set(ACM_GLSL_COMPILER_FLAG "-V" CACHE STRING "GLSL compiler flag")
	else()
		...
		# An executable target name is resolved to its built path (and added as
		# a build dependency) when used in add_custom_command COMMAND.
		set(ACM_GLSL_COMPILER "glslang-standalone" CACHE STRING "GLSL->SPIR-V compiler command")
		set(ACM_GLSL_COMPILER_FLAG "-V" CACHE STRING "GLSL compiler flag")
	endif()
endif()
