...
namespace acm
{
	...
	public:
		...
		acm::Device createDevice(const acm::DeviceInfo& deviceInfo, uint32_t queueFamily, const acm::DeviceConfig& config = {});
		acm::Device createDevice(const acm::DeviceOption& option, const acm::DeviceConfig& config = {});
