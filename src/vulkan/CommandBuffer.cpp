...
acm::Error acm::vulkan::CommandBuffer::begin()
{
...
acm::Error acm::vulkan::CommandBuffer::end()
{
...
void acm::vulkan::CommandBuffer::beginRendering(const acm::RenderTarget& target, float r, float g, float b, float a)
{
...
void acm::vulkan::CommandBuffer::endRendering()
{
...
void acm::vulkan::CommandBuffer::setViewportAndScissor(acm::Extent2D extent)
{
	VkViewport viewport = {};
...
void acm::vulkan::CommandBuffer::bindPipeline(const acm::vulkan::Pipeline& pipeline)
{
...
void acm::vulkan::CommandBuffer::bindDescriptorSet(const acm::vulkan::Pipeline& pipeline, const acm::vulkan::DescriptorSet& set, const uint32_t* dynamicOffset)
{
...
void acm::vulkan::CommandBuffer::draw(uint32_t vertexCount, uint32_t instanceCount, uint32_t firstVertex, uint32_t firstInstance)
{
	vkCmdDraw(m_commandBuffer, vertexCount, instanceCount, firstVertex, firstInstance);
}

void acm::vulkan::CommandBuffer::bindVertexBuffer(const acm::vulkan::Buffer& buffer)
{
...
void acm::vulkan::CommandBuffer::bindIndexBuffer(const acm::vulkan::Buffer& buffer)
{
	if (&owner() != &buffer.owner())
		return;
	const VkBuffer vkBuffer = buffer.vkBuffer();
...
void acm::vulkan::CommandBuffer::drawIndexed(uint32_t indexCount, uint32_t instanceCount, uint32_t firstIndex, int32_t vertexOffset, uint32_t firstInstance)
{
	vkCmdDrawIndexed(m_commandBuffer, indexCount, instanceCount, firstIndex, vertexOffset, firstInstance);
}

void acm::vulkan::CommandBuffer::copyTextureToBuffer(const acm::vulkan::Texture& texture, const acm::vulkan::Buffer& buffer)
{
...
void acm::vulkan::CommandBuffer::bindComputePipeline(const acm::vulkan::ComputePipeline& pipeline)
{
	if (&owner() != &pipeline.owner())
		return;
	const VkPipeline vkPipeline = pipeline.vkPipeline();
...
void acm::vulkan::CommandBuffer::bindComputeDescriptorSet(const acm::vulkan::ComputePipeline& pipeline, const acm::vulkan::DescriptorSet& set)
{
	if (&owner() != &pipeline.owner() || &owner() != &set.owner())
		return;
	const VkPipelineLayout layout = pipeline.vkLayout();
...
void acm::vulkan::CommandBuffer::dispatch(uint32_t groupsX, uint32_t groupsY, uint32_t groupsZ)
{
	vkCmdDispatch(m_commandBuffer, groupsX, groupsY, groupsZ);
}

void acm::vulkan::CommandBuffer::bufferBarrier(const acm::vulkan::Buffer& buffer, acm::ShaderStage srcStage, acm::ShaderStage dstStage)
{
	if (&owner() != &buffer.owner())
		return;
	const VkBuffer vkBuffer = buffer.vkBuffer();
...
void acm::vulkan::CommandBuffer::transitionImage(const acm::vulkan::Texture& texture, acm::ImageLayout from, acm::ImageLayout to)
{
