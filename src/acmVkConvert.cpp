...
namespace acm
{
	namespace detail
	{
		VkFormat toVk(acm::Format format)
		{
			...
			assert(false && "acm::detail::toVk: invalid acm::Format");
			return VK_FORMAT_UNDEFINED;
		}
		...
		VkColorSpaceKHR toVk(acm::ColorSpace colorSpace)
		{
			...
			assert(false && "acm::detail::toVk: invalid acm::ColorSpace");
			return VK_COLOR_SPACE_SRGB_NONLINEAR_KHR;
		}
		...
		VkPresentModeKHR toVk(acm::PresentMode mode)
		{
			...
			assert(false && "acm::detail::toVk: invalid acm::PresentMode");
			return VK_PRESENT_MODE_FIFO_KHR;
		}
		...
		VkBufferUsageFlags toVk(acm::BufferUsage usage)
		{
			...
			assert(false && "acm::detail::toVk: invalid acm::BufferUsage");
			return 0;
		}
		...
		VkDescriptorType toVk(acm::DescriptorType type)
		{
			...
			assert(false && "acm::detail::toVk: invalid acm::DescriptorType");
			return VK_DESCRIPTOR_TYPE_UNIFORM_BUFFER;
		}
		...
		VkShaderStageFlags toVk(acm::ShaderStage stage)
		{
			...
			assert(flags != 0 && "acm::detail::toVk: empty acm::ShaderStage");
			return flags;
		}
		...
		VkPrimitiveTopology toVk(acm::Topology topology)
		{
			...
			assert(false && "acm::detail::toVk: invalid acm::Topology");
			return VK_PRIMITIVE_TOPOLOGY_TRIANGLE_LIST;
		}
		...
		VkCullModeFlags toVk(acm::CullMode cull)
		{
			...
			assert(false && "acm::detail::toVk: invalid acm::CullMode");
			return VK_CULL_MODE_NONE;
		}
		...
		VkFrontFace toVk(acm::FrontFace front)
		{
			...
			assert(false && "acm::detail::toVk: invalid acm::FrontFace");
			return VK_FRONT_FACE_CLOCKWISE;
		}
		...
		VkPolygonMode toVk(acm::PolygonMode mode)
		{
			...
			assert(false && "acm::detail::toVk: invalid acm::PolygonMode");
			return VK_POLYGON_MODE_FILL;
		}
